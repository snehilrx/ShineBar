...
class Shinebar : FrameLayout, AppBarLayout.OnOffsetChangedListener {
    ...
    @Suppress("unused")
    class ShinebarBehaviour : CoordinatorLayout.Behavior<Shinebar> {
        constructor() : super()
        constructor(context: Context?, attrs: AttributeSet?) : super(context, attrs)
        ...
        override fun onDependentViewChanged(
            ...
            val appbar = dependency as? AppBarLayout ?: return false
            if (child.layoutParams?.height != appbar.height) {
